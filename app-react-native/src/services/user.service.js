    ...
    UserService.prototype.getHeaders = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, session_repository_1.session.getLoggedUser()];
                    case 1:
                        logged = _a.sent();
                        if (!logged)
                        ...
                        return [2 /*return*/, {
                                ...
                                'Authorization': "Bearer ".concat(logged.token)
                            }];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _a = fetch;
                        _b = ["".concat(this.url, "/").concat(id)];
                        _d = {
                            method: 'GET'
                        };
                        return [4 /*yield*/, this.getHeaders()];
                    case 1: return [4 /*yield*/, _a.apply(void 0, _b.concat([(_d.headers = _e.sent(),
                                _d)]))];
                    case 2:
                        response = _e.sent();
                        ...
                        _c = Error.bind;
                        return [4 /*yield*/, response.json()];
                    case 3: throw new (_c.apply(Error, [void 0, _e.sent()]))();
                }
            });
        });
    };
